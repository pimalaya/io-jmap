...
**I/O-free** JMAP client library written in Rust, based on [io-http](https://github.com/pimalaya/io-http)

## Table of contents

- [RFC coverage](#rfc-coverage)
- [Examples](#examples)
  - [Fetch a JMAP session (blocking)](#fetch-a-jmap-session-blocking)
  - [List mailboxes (blocking)](#list-mailboxes-blocking)
