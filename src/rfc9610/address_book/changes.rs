//! JMAP `AddressBook/changes` coroutine (RFC 9610 §2.2): wraps the generic
...
//! let mut coroutine = JmapAddressBookChanges::new(
//!     &session,
//!     &auth,
//!     "s1",
//!     JmapAddressBookChangesOptions::default(),
//! )
//! .unwrap();
//! let mut arg = None;
//!
...
/// Failure causes during a JMAP `AddressBook/changes` flow.
#[derive(Debug, Error)]
...
/// Options for [`JmapAddressBookChanges::new`].
...
impl JmapCoroutine for JmapAddressBookChanges {
    ...
    fn resume(&mut self, arg: Option<&[u8]>) -> JmapCoroutineState<Self::Yield, Self::Return> {
        trace!("AddressBook/changes: {}", self.state);
