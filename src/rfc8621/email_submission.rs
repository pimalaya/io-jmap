...
/// Per-object error returned in `EmailSubmission/set` responses (RFC 8621 §7.5).
#[derive(Clone, Debug, Deserialize)]
#[serde(tag = "type", rename_all = "camelCase")]
pub enum EmailSubmissionSetError {
    // ── RFC 8621 §7.5 ────────────────────────────────────────────────────
    /// The message had too many recipients.
    TooManyRecipients {
    ...
    /// One or more recipient addresses were invalid.
    InvalidRecipients {
        description: Option<String>,
    },
    /// The From address is not permitted for this identity.
    ForbiddenFrom {
        description: Option<String>,
    },
    /// The MAIL FROM address is not permitted.
    ForbiddenMailFrom {
        description: Option<String>,
    },
    /// This user is not permitted to send email.
    ForbiddenToSend {
        description: Option<String>,
    },
    /// The submission cannot be unsent.
    CannotUnsendMessage {
        description: Option<String>,
    },
    /// The email object was not a valid message.
    InvalidEmail {
        description: Option<String>,
    },
