...
pub enum EmailSetError {
    // ── RFC 8621 §4.7 ────────────────────────────────────────────────────
    /// The email would exceed the server's keyword limit.
    TooManyKeywords {
    ...
    /// One or more blob IDs in the email were not found.
    BlobNotFound {
        description: Option<String>,
    },
...
pub enum EmailImportError {
    // ── RFC 8621 §4.9 ────────────────────────────────────────────────────
    /// The message body was not a valid RFC 5322 message.
    InvalidEmail {
        description: Option<String>,
    },
    // ── RFC 8620 §5.3 standard set errors ────────────────────────────────
...
pub enum EmailCopyError {
    // ── RFC 8621 §4.10 ───────────────────────────────────────────────────
    /// The email already exists in the destination account.
    AlreadyExists {
        description: Option<String>,
    },
    // ── RFC 8620 §5.3 standard set errors ────────────────────────────────
