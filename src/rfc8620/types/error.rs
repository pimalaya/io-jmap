...
pub enum JmapMethodError {
    ...
    ServerUnavailable { description: Option<String> },

    /// The `using` array references a capability the server does not support.
    UnknownCapability { description: Option<String> },

    /// The request body was not valid JSON.
    NotJson { description: Option<String> },

    /// The request body was valid JSON but not a valid JMAP request.
    NotRequest { description: Option<String> },
    ...
    UnknownMethod { description: Option<String> },
